...
public class DialogueUI : MonoBehaviour
{
    ...
    public Image obtainedItemImage;
    ...
    public void SetImageForObtainedObject(Sprite icon)
    {
        obtainedItemImage.color = new Color(255f, 255f, 255f, 255f);
        this.obtainedItemImage.sprite = icon;
    }
    public void UnableImageForObtainedObject()
    {
        obtainedItemImage.color = new Color(255f, 255f, 255f, 0);
    }
    public void FinishButtonLine(string buttonFinishLine)
    {
        if (buttonFinishLine.Equals("") || buttonFinishLine.Equals(null))
        {
            buttonText.text = "Finish";
        }
        else
        {
            buttonText.text = buttonFinishLine;
        }
